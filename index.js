...
/* ---------------------------------------------------------
   New Routes for Home and Dev pages
--------------------------------------------------------- */
...
// API endpoint to check if credentials exist
...
/* ---------------------------------------------------------
   Modify the main route to redirect if not configured
--------------------------------------------------------- */
  ...
  try {
    ...
    authorize(credentials, async (auth) => {
      try {
        ...
        // If authorization fails, redirect to home
